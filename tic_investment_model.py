...
# Ownership percentage in TIC
ownership_percentage = 0.34
...
deductible_mortgage_interest = annual_mortgage_interest * min(loan_amount, 750000) / loan_amount * ownership_percentage

# SALT deduction (capped at $10,000 per owner)
deductible_salt = min(annual_property_taxes * ownership_percentage, 10000)
